...
// import { PropertyLocation, PropertyType, WatchGender } from '../../enums/property.enum';
...
// 			try {
// 				if (number != 0) {
// 					if (searchFilter?.search?.pricesRange?.includes(number)) {
// 						setSearchFilter({
// 							...searchFilter,
// 							search: {
// 								...searchFilter.search,
// 								typeList: searchFilter?.search?.pricesRange?.filter((item: Number) => item !== number),
// 							},
// 						});
// 					} else {
// 						setSearchFilter({
...
// 												<div
// 													className={`room ${searchFilter?.search?.propertyCategory?.includes(WatchGender) ? 'active' : ''}`}
